...
const ImageGallery = ({
  ...
  return (
    ...
    >
      <div
        className={clsx(generateClasses('relative cursor-pointer h-full w-full overflow-hidden', classNames.mainImageWrapper),
          {
      ...
      <div className="relative w-fit h-fit">
        <div
          ...
          className={clsx(
            generateClasses('flex shrink-0 scrollbar-hide', classNames.thumbnailsReel),
            {
            ...
            >
              {image.Image ? (
                ...
                <img
                  ...
                  alt={image.alt}
                  draggable={false}
                  className={clsx(generateClasses('object-contain w-full h-full', classNames.thumbnailImage))}
                />
              )}
            </div>
          ))}
