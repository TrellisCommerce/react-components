...
// TODO: Add magnify effect
// TODO: Enhance img responsiveness
const ImageGallery = ({
  reelPosition = 'bottom',
  isBestSeller,
  classNames = {},
  ...
  return (
    ...
    >
      <div
        className={clsx(
          'relative cursor-pointer w-[270px] h-[234px] md:w-[714px] md:h-[551px] lg:w-[678px] lg:h-[589px] overflow-hidden',
      ...
      >
        {MainImageComponent ? (
          MainImageComponent(images[galleryIndex].imageUrl)
        ) : (
          <img
            draggable={false}
