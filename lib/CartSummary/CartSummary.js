    ...
    <div className={clsx(classNames?.root)}>
      ...
      {cartItems?.map((item) => (
        <div  key={item.id} className={clsx('flex border-b border-gray-300', (firstItemInAnObject(cartItems).id === item.id) && 'border-t')}>
          <div
            className={clsx(
              generateClasses('grid row-end-auto grid-cols-[.1fr,3.9fr,1fr,1fr] py-3 w-11/12' ,
          ...
          >
            ...
            <div className={clsx('flex items-center justify-start lg:col-span-1 col-span-3 order-2')}>
              <div>
                <p className={clsx(generateClasses('font-bold leading-6 text-[18px]', classNames?.productTitle))}>
                  {item.title}
                </p>
                <p
            ...
            <div className={clsx('flex items-center justify-start lg:col-span-1 col-span-3 lg:order-3 order-4')}>
            ...
            <div className={clsx("flex items-center justify-start lg:col-span-1 col-span-3 order-3 lg:order-4")}>
              <div
                className={clsx(generateClasses(
