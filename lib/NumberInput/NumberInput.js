...
function NumberInput(props) {
  ...
  return (
    <fieldset
      className={clsx(
        generateClasses('flex border border-gray-300 w-min overflow-hidden h-8',
    ...
    >
      ...
      <button
        className={clsx(
          generateClasses('px-1 text-slate-300 hover:text-black hover:bg-slate-100 focus:bg-slate-300 focus:text-black w-8', classNames?.field?.plus)
        )}
